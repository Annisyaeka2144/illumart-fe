  ...
  const handleBuyNow = (novel) => {
    navigate("/transaksi", {
      state: {
        ...
        harga: novel.harga,
        gambar: `https://rw-illlumart-production.up.railway.app/${novel.file_path.replace(/\\/g, "/")}`,
      },
    });
  };
      ...
      <div className="novel-list">
        {novelList.map((novel, index) => (
          <div key={index} className="novel-card">
            ...
            <img
              src={`https://rw-illlumart-production.up.railway.app/${novel.file_path.replace(/\\/g, "/")}`}
              alt={novel.nama}
